(function () {
  ...
  angular.module('app.controller.bagi_kajian.add_kota', [])

  .controller('pilihKotaCtrl', ['$scope', '$stateParams', 'BagiKajian', '$state', '$timeout', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
